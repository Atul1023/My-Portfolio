...
class StandingGuy extends Component {
  render() {
    ...
    return (
      <svg
        ...
        width="887.876"
        height="652.024"
        viewBox="40 -50 751.1879 709.68268"
      >
        <path
        ...
        <path
          fill="#ffb8b8"
          d="M785.259 567.02l-6.055 13.12-11.102-1.009-7.064-23.213 11.101-6.055 13.12 17.157zm38.113 30.217l.239 9.143-17.157 1.01v-11.102l16.918.949z"
        />
        <path
          fill="#2f2e41"
        ...
        />
        <path
          d="M763.056 249.108l-8.074-1.01s-2.018 1.01-3.028 8.075-13.12 69.637-13.12 69.637l16.148 76.703 18.166-24.222-11.101-42.388 11.102-42.388zm102.943-1.009h6.055l15.139 81.748-14.129 63.583-14.13-23.213 4.037-25.231-2.018-22.203-7.065-13.121 12.111-61.563zm-89.823 328.004s6.056-2.018 6.056 2.019-4.037 16.147-4.037 16.147 6.055 37.342-3.028 35.324-16.148-19.176-17.157-24.222-6.056-31.286-6.056-31.286-8.074-19.176-3.027-20.185 19.175-5.047 19.175-5.047-8.074 25.231 8.074 27.25zm29.268 31.287s16.148-10.093 19.176-2.019a84.8 84.8 0 014.037 18.166s4.037 13.12-12.11 11.102-14.13-2.018-15.14-8.074 4.037-19.175 4.037-19.175zm13.121-412.781l-4.037-1.01s-3.028-17.157-10.093-15.138-25.231 4.037-25.231-4.037 17.157-15.139 27.25-14.13 27.25 4.037 26.24 19.176-7.522 29.865-7.522 29.865l-.526-8.975z"
          fill="#2f2e41"
        />
        <path
          fill={theme.jacketColor}
          d="M797.37 254.154l17.158-12.111-17.158-14.129-5.956 7.148 5.956 19.092zm32.296-1.009l-15.138-11.102 12.11-18.166 7.065 9.083-4.037 20.185z"
        />
        <path
        ...
        <path fill={theme.text} d="M185.418 111.101h216.625v8.053H185.418z" />
        <path
          fill="#e6e6e6"
          d="M185.418 138.776h176.544v8.053H185.418zm0 27.57h103.064v8.053H185.418zm0 27.57h155.55v8.053h-155.55zM121.481 78.864h17.177v17.177h-17.177z"
        />
        <path fill={theme.text} d="M121.481 106.539h17.177v17.177h-17.177z" />
        <path
          fill="#e6e6e6"
          d="M121.481 134.213h17.177v17.177h-17.177zm0 27.675h17.177v17.177h-17.177zm0 27.674h17.177v17.177h-17.177zm412.255-71.572h57.258v57.258h-57.258z"
        />
        <path fill="#fff" d="M20.419 252.546h663.338v171.773H20.419z" />
        <path fill="#e6e6e6" d="M151.064 267.812h17.177v17.177h-17.177z" />
        <path fill={theme.text} d="M121.481 267.812h17.177v17.177h-17.177z" />
        <path
          d="M412.724 305.375a65.046 65.046 0 00-105.003-9.7l-4.186-3.657a70.594 70.594 0 01113.973 10.526z"
          fill="#e6e6e6"
        />
        <path
          d="M415.344 377.794l-4.614-3.102a65.078 65.078 0 001.994-69.317l4.784-2.831a70.637 70.637 0 01-2.164 75.25zm-111.23 7.745a70.59 70.59 0 01-.58-93.521l4.187 3.657a65.03 65.03 0 00.534 86.155z"
          fill={theme.text}
        />
        <path
        ...
        <path
          fill="#e6e6e6"
          d="M533.736 305.032h57.258v57.258h-57.258zm-414.641 37.217h57.258v57.258h-57.258z"
        />
        <path fill={theme.text} d="M0 0h703.576v29.89H0z" />
